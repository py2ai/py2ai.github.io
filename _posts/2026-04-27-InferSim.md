---
layout: post
title: "InferSim: LLM Inference Simulation by Alibaba"
description: "Learn how InferSim by Alibaba do simulation. This guide covers installation, architecture, and real-world applications for VLSI design."
date: 2026-04-27
header-img: "img/post-bg.jpg"
permalink: /InferSim/
featured-img: ai-coding-frameworks/ai-coding-frameworks
categories: [AI, EDA, VLSI, Open Source]
tags: [InferSim, AI, VLSI, EDA, machine learning, Alibaba, open source, deep learning]
keywords: "InferSim simulation, how to use InferSim, InferSim installation guide, Alibaba InferSim tutorial, machine learning inference simulation, fast analog simulation tool, InferSim open source setup, neural network EDA tool"
author: "PyShine"
image: /assets/img/diagrams/infersim/infersim-architecture.svg
---

## Introduction

InferSim is a lightweight, simulation framework developed by Alibaba's Alimama AI Infra Team and Future Living Lab. It simulates the inference performance of Large Language Models (LLMs) on GPU hardware. In the context of simulation, InferSim bridges the gap between model architecture design and deployment planning by calculating critical metrics such as TTFT (Time To First Token), TPOT (Time Per Output Token), and TGS (Tokens per GPU per Second) without requiring actual hardware execution.
