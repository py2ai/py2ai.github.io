...
put a video file in the same folder as the Python code below. Also the xml file should be in the same folder as shown in the video.



Updated version with Start/Stop toggle button is added based on the suggestion from Ilker. This one is updated proces_version2.py.
