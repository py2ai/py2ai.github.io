...
description: 'Hi there! today we will build a multilayer model that should be like this:
...
!![lab3 keras model]({{ "assets/img/posts/lab3_keras_model.png" | absolute_url }}). 
